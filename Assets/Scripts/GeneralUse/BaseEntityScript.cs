...
public class BaseEntityScript : MonoBehaviour
{
    ...
    protected float originalBulletCoolDown;
    protected float lastDamageValue;
    protected bool isSlowedDownShooting = false;
    private Collider2D collider2d;
    protected PlayerMovement player;
    private bool isCounted = true; //this is for the wave management, enemies generated by the factory or sun doesn`t count 
    ...
    [SerializeField] protected AudioClip multipleShotSound;
    [SerializeField] protected AudioClip deathSound;
    private bool deathSoundLock = true;
    void Start()
    {
        originalSpeed = speed;
